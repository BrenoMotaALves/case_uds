...
exports.CreateBoardUseCase = void 0;
const common_1 = require("@nestjs/common");
const boards_repository_1 = require("../infra/boards.repository");
const DEFAULT_COLUMNS = ['To Do', 'In Progress', 'Done'];
let CreateBoardUseCase = class CreateBoardUseCase {
...
exports.CreateBoardUseCase = CreateBoardUseCase;
exports.CreateBoardUseCase = CreateBoardUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(boards_repository_1.BOARDS_REPOSITORY)),
    __metadata("design:paramtypes", [Object])
], CreateBoardUseCase);
//# sourceMappingURL=create-board.usecase.js.map